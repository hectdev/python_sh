...
/*!*********************!*\
  !*** ./js/utils.js ***!
  \*********************/
/*! exports provided: addColorToDelta, generateURLHash, format, formatSteps, preferenceFormSave, formatLoop, formatChart, computePayoff, effortMSG, findZero, setCookie, getCookie */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"addColorToDelta\", function() { return addColorToDelta; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"generateURLHash\", function() { return generateURLHash; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"format\", function() { return format; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"formatSteps\", function() { return formatSteps; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"preferenceFormSave\", function() { return preferenceFormSave; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"formatLoop\", function() { return formatLoop; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"formatChart\", function() { return formatChart; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"computePayoff\", function() { return computePayoff; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"effortMSG\", function() { return effortMSG; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"findZero\", function() { return findZero; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"setCookie\", function() { return setCookie; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getCookie\", function() { return getCookie; });\n/* harmony import */ var _moment_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./moment.min */ \"./js/moment.min.js\");\n/* harmony import */ var _moment_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_moment_min__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _moment_timezone_with_data_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./moment-timezone-with-data.min */ \"./js/moment-timezone-with-data.min.js\");\n/* harmony import */ var _moment_timezone_with_data_min__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_moment_timezone_with_data_min__WEBPACK_IMPORTED_MODULE_1__);\n\n\n\nfunction addColorToDelta(str) {\n    if (str.includes('second')) {\n        return '<span style=\"color:#FF0030\">' + str + '</span>';\n    } else if (str.includes('minute')) {\n        return '<span style=\"color:#FF9600\">' + str + '</span>';\n    } else if (str.includes('hour')) {\n        return '<span style=\"color:#0084FF\">' + str + '</span>';\n    } else {\n        return str;\n    }\n}\n\nfunction generateURLHash(urlParamsMap) {\n    let paramHash = '';\n\n    urlParamsMap.forEach(function(value, key) {\n        if(value.length === 0)\n            return;\n\n        paramHash += key;\n        paramHash += '=' + value + '&';\n    });\n\n    if(paramHash.charAt(paramHash.length - 1) === '&')\n        paramHash = paramHash.substr(0, paramHash.length - 1);\n\n    return paramHash;\n}\n\nfunction format(row) {\n    const data = {\n        stepsHtml: formatSteps(row),\n        marketDataHtml: formatMarketData(row),\n        detailsHtml: formatDetails(row),\n        headLoopsHtml: formatHeadLoops(row),\n        //loopsHtml: formatLoop(row),\n        chartHtml: formatChart(row)\n    };\n    $.views.settings.delimiters(\"[%\", \"%]\");\n    const result = $.templates('#details-tpl').render(data);\n    $.views.settings.delimiters(\"{{\", \"}}\");\n    return result;\n}\n\nfunction formatDetails(row) {\n    const m = _moment_min__WEBPACK_IMPORTED_MODULE_0__[\"parseZone\"](row.dt).local();\n\n    //transfers^2 * hops ^ (3/2) / (100 * return)\n    const effort = Math.pow(row.transfers, 2) * Math.pow(row.hops, 1.5) / (100 * row.return);\n    const spread = (row.spread * 100).toFixed(2)\n    let effMSG = effortMSG(effort);\n\n    const date = _moment_min__WEBPACK_IMPORTED_MODULE_0__(m);\n    const userTimezone = Intl.DateTimeFormat().resolvedOptions().timeZone;\n    const rightDate = date.tz(userTimezone).format('MMMM Do YYYY, h:mm:ss a');\n\n\n    let html = `\n        <h3 class=\"subtitle\">${detailsHeading}</h3>\n        <ul class=\"detailsList\">\n            <li><span>${spreadHeading}:</span> <p>${spread}%</p></li>\n            <li><span>${discoveryHeading}:</span> <p>${m.fromNow()} (${rightDate}, timezone ${userTimezone})</p></li>\n\n            <!--<li><span>Discovery:</span> ${m.fromNow()} (${rightDate}, timezone ${userTimezone})</li>\n            <li><span>Return:</span> ${(row.return * 100).toFixed(2)}%</li>\n            <li><span>Effort:</span> ${Math.round(effort * 100) / 100} (${effMSG})</li>-->\n        </ul>\n    `;\n\n    return html;\n}\n\nfunction formatMarketData(row) {\n    let html = `\n        <h3 class=\"subtitle\">${marketDataHeading}</h3>\n    `;\n\n    Object.keys(row.spread_info).forEach((key, i) => {\n        if(i > 1)\n            return;\n\n        if((typeof(row.spread_info[key]) === 'object') && ('rate' in row.spread_info[key])) {\n            html += '<ul class=\"detailsList2 detailsList2-row\">';\n            html += `<li><span class=\"detailsList-zero\"></span></li>`;\n            html += `<li><span>${rateHeading}:</span></li>`;\n            html += `<li><span>${volumeHeading}:</span></li>`;\n\n            html += `<li><span>${takerFeeHeading}:</span></li>`;\n            html += `<li><span>${makerFeeHeading}:</span></li>`;\n\n            html += '</ul>';\n        }\n    });\n\n    Object.keys(row.spread_info).forEach((key, i) => {\n        const vol = Math.round(parseFloat(row.spread_info[key].vol) * 10000) / 10000;\n        if((typeof(row.spread_info[key]) === 'object') && ('rate' in row.spread_info[key])) {\n            html += '<ul class=\"detailsList2\">';\n            html += `<li><h5 class=\"detailsList__title\">${row.spread_info[key].exch} ${row.spread_info[key].a}/${row.spread_info[key].b}: </h5>`;\n            html += (i === 1) ? `<p>${row.spread_info[key].rate}</p></li>` : `<p>${row.spread_info[key].rate}</p></li>`;\n            html += (i === 1) ? `<li><p>${vol} BTC</p></li>` : `<li><p>${vol} BTC</p></li>`;\n\n            const takerFee = Math.round(parseFloat(row.simulations.taker_fee.fee[row.spread_info[key].exch + '']) * 10000) / 10000;\n            const makerFee = Math.round(parseFloat(row.simulations.maker_fee.fee[row.spread_info[key].exch + '']) * 10000) / 10000;\n\n            html += (i === 1) ? `<li><p>${takerFee} %</p></li>` : `<li><p>${takerFee} %</p></li>`;\n            html += (i === 1) ? `<li><p>${makerFee} %</p></li>` : `<li><p>${makerFee} %</p></li>`;\n\n            html += '</ul>';\n        }\n    });\n\n    return html;\n}\n\nfunction formatHeadLoops(row) {\n    let html = '<h3 class=\"subtitle\">Loop</h3>';\n\n    row.spread_info.trade.forEach( (item, i) => {\n        html += `\n              <span class=\"btn-group\" style=\"display: inline-flex; margin-top: 2px\">\n                  <button class=\"btn-sm btn-outline\">${item[0]}</button>\n                  <button class=\"btn-sm\">${item[1]}</button>\n              </span>\n        `;\n    });\n    return html;\n}\n\nfunction formatSteps(row) {\n    var html = '<h3 class=\"subtitle\">Required trades</h3><ul class=\"StepProgress\">';\n\n    if(row && row.trades) {\n        Object.keys(row.trades).forEach((key, i) => {\n            html += '<li class=\"StepProgress-item ';\n\n            switch(row.trades[key][0]) {\n                case 'buy':\n                    html += 'StepProgress-item-pink\">';\n                    html += '<p><strong>' + 'buy ' + '</strong>&nbsp;&nbsp;';\n                    html += '<span class=\"btn-group\" style=\"display:inline-block\">' +\n                        '<button class=\"btn-sm btn-success' +\n                        '\">' + row.trades[key][1] + '</button><button class=\"btn-sm btn-outline-success\">' +\n                        row.trades[key][2] + '/' + row.trades[key][3] + '</button></span></p>';\n                    break;\n                case 'sell':\n                    html += 'StepProgress-item-green\">';\n                    html += '<p><strong>' + 'sell ' + '</strong>&nbsp;&nbsp;';\n                    html += '<span class=\"btn-group\" style=\"display:inline-block\">' +\n                        '<button class=\"btn-sm btn-error' +\n                        '\">' + row.trades[key][1] + '</button><button class=\"btn-sm btn-outline-error\">' +\n                        row.trades[key][2] + '/' + row.trades[key][3] +'</button></span></p>';\n                    break;\n            }\n\n            html += '</li>';\n        });\n    }\n    /*for (var i = 0; i < row.plan.length; i++) {\n        var action = row.plan[i];\n        html += '<li class=\"StepProgress-item ';\n        if (action.type === 'fixed') {\n            var word = i === 0 ? 'Start' : 'End';\n            var x = i === 0 ? action.amount : parseFloat(action.amount).toFixed(8);\n            html += '\">';\n            html += word + ' with ' + x + ' ' + action.market.ticker + ' on ';\n            html += action.market.exch;\n        } else if (action.type === 'buy' || action.type === 'sell') {\n            var butType = action.type === 'buy' ? 'success' : 'error';\n            var pieces = action.market.split(':', 2);\n            html += action.type === 'buy' ? 'StepProgress-item-pink\">' : 'StepProgress-item-green\">';\n\n            html += '<p><strong>' + action.type + '</strong>&nbsp;&nbsp;';\n            html += '<span class=\"btn-group\" style=\"display:inline-block\">' +\n                '<button class=\"btn-sm btn-' + butType +\n                '\">' + pieces[0] + '</button><button title=\"' +\n                action.amount + '\" class=\"btn-sm btn-outline-' + butType + '\">' +\n                pieces[1] + '</button></span></p>';\n            html += '<p style=\"display:none\"><span class=\"small-subtitle\">at a price of <code>';\n            html += parseFloat(action.price).toFixed(8);\n            html += '</code> or better</span></p>';\n        } else if (action.type === 'transfer') {\n            html += 'StepProgress-item-yellow\">';\n            html += '<strong>' + action.type + '</strong> from ' +\n                action.a.market.exch + ' to ' + action.b.market.exch +\n                ' with a <code>' + action.fee + '</code> ' +\n                getEndMarket(row.plan[i - 1]) + ' fee';\n        }\n        html += '</li>';\n    }*/\n    html += '</ul>';\n    return html;\n}\n\nfunction preferenceFormSave() {\n    $('#savePreferencesForm').on('submit', event => {\n        event.preventDefault();\n\n        let data = {};\n        $('.prefExclInputDiv').each((i, div) => {\n            const key = $(div).children('h3').text();\n\n            data['' + key] = [];\n            $(div).find('.preferenceExclInput').each((i, input) => {\n                const inputVal = $(input).val();\n                if(inputVal)\n                    data['' + key].push(inputVal);\n            });\n        });\n\n        console.log('data', data);\n    });\n}\n\nfunction formatLoop(row) {\n    var html = '<h3 class=\"subtitle\">Arbitrage loop</h3><ul style=\"list-style:none\">';\n    for (var i = 0; i < row.loop.length; i++) {\n        html += '<li><button class=\"btn btn-sm\">' + row.loop[i];\n        html += '</button></li>';\n    }\n    html += '</ul>';\n    return html;\n}\n\nfunction formatAmountInput(row) {\n    var html = '<h6 class=\"modal__control--panel\">Starting amounts</h6><ul>';\n    row.spread_info.trade.forEach( (item, i) => {\n        let input_id = item[0] + \"_amount_input\";\n        html += '<li class=\"dash__modal-input-textbox\"><label for=' + input_id + ' class=\"modal__control--panel\">' + item[0] + '/' + item[1] + '</label>';\n        html += '<input id=' + input_id + ' type=\"number\" name=' + input_id + ' class=\"dark-text\"/>';\n        html += '</li>';\n    });\n    html += '</ul>'\n    return html;\n}\n\nfunction formatChart(row) {\n    let data = [];\n    let dataMakerFees = [];\n    let dataTakerFees = [];\n    let xs = [];\n    let v = [null];\n\n    if($.isEmptyObject(row.simulations)) {\n        return '<h5 style=\"font-size: 14px\">No simulations available for this arbitrage opportunity</h5>';\n    }\n\n    for(let i = 0; i < row.amounts.length; i++) {\n        data.push({ x: parseFloat(row.amounts[i]),\n            y: parseFloat(row.simulations.no_fee.pl[i]) * 100 });\n    }\n\n    for(let i = 0; i < row.amounts.length; i++) {\n        dataMakerFees.push({ x: parseFloat(row.amounts[i]),\n            y: parseFloat(row.simulations.maker_fee.pl[i]) * 100 });\n    }\n\n    for(let i = 0; i < row.amounts.length; i++) {\n        dataTakerFees.push({ x: parseFloat(row.amounts[i]),\n            y: parseFloat(row.simulations.taker_fee.pl[i]) * 100 });\n    }\n\n    for (let i = 0; i < data.length - 1; i++) {\n        if (data[i].y <= 0 && data[i + 1].y >= 0) {\n            v = findZero(data[i].x, data[i + 1].x, row);\n            data.splice(i + 1, 0, { x: v[0], y: v[1] });\n            break;\n        }\n    }\n\n    for (let i = 0; i < dataMakerFees.length - 1; i++) {\n        if (dataMakerFees[i].y <= 0 && dataMakerFees[i + 1].y >= 0) {\n            v = findZero(dataMakerFees[i].x, dataMakerFees[i + 1].x, row);\n            dataMakerFees.splice(i + 1, 0, { x: v[0], y: v[1] });\n            break;\n        }\n    }\n\n    for (let i = 0; i < dataTakerFees.length - 1; i++) {\n        if (dataTakerFees[i].y <= 0 && dataTakerFees[i + 1].y >= 0) {\n            v = findZero(dataTakerFees[i].x, dataTakerFees[i + 1].x, row);\n            dataTakerFees.splice(i + 1, 0, { x: v[0], y: v[1] });\n            break;\n        }\n    }\n\n    for (let i = 0; i < Math.max(data.length, dataMakerFees.length, dataTakerFees.length); i++) { xs.push(data[i].x); }\n\n    let data2 = {\n        chartId: 'chart-' + row.DT_RowId,\n        xs: JSON.stringify(xs),\n        dataNoFees: JSON.stringify(data),\n        dataMakerFees: JSON.stringify(dataMakerFees),\n        dataTakerFees: JSON.stringify(dataTakerFees),\n        v,\n        loop_markets: JSON.stringify(row.spread_info.trade),\n        amount_input_html: formatAmountInput(row),\n    };\n\n    $.views.settings.delimiters(\"[%\", \"%]\");\n    let result = $.templates('#pl-chart-tpl').render(data2);\n    $.views.settings.delimiters(\"{{\", \"}}\");\n    return result;\n}\n\nfunction computePayoff(x, plan) {\n    var start = x;\n    for (var i = 1; i < plan.length - 1; i++) {\n        var action = plan[i];\n        if (action.type === 'transfer') {\n            x -= parseFloat(action.fee);\n        } else if (action.type === 'buy' || action.type === 'sell') {\n            var price = parseFloat(action.price);\n            x = action.type === 'buy' ? x / price : x * price;\n            x *= (1 - parseFloat(action.fee));\n        }\n    }\n    return (x / start - 1) * 100;\n}\n\nfunction effortMSG(effort, ultraLow = 1, low = 3, medium = 6) {\n    let effMSG;\n\n    if (parseFloat(effort) < ultraLow){\n        effMSG = 'Ultra Low';\n    } else if (parseFloat(effort) < low) {\n        effMSG = 'Low';\n    } else if (parseFloat(effort) < medium) {\n        effMSG = 'Medium';\n    } else {\n        effMSG = 'High';\n    }\n\n    return effMSG;\n}\n\nfunction findZero(a, b, row) {\n    var mid, y;\n    for (var i = 0; i < 1000; i++) {\n        mid = (a + b) / 2;\n        y = computePayoff(mid, row);\n        if (Math.abs(y) < 1e-6) break;\n        if (y < 0) a = y;\n        else b = y;\n    }\n    return [mid, y];\n}\n\nfunction setCookie(cname, cvalue, exdays) {\n    var d = new Date();\n    d.setTime(d.getTime() + (exdays*24*60*60*1000));\n    var expires = \"expires=\" + d.toGMTString();\n    document.cookie = cname + \"=\" + cvalue + \";\" + expires + \";path=/\";\n}\n\nfunction getCookie(cname) {\n    var name = cname + \"=\";\n    var decodedCookie = decodeURIComponent(document.cookie);\n    var ca = decodedCookie.split(';');\n    for(var i = 0; i < ca.length; i++) {\n        var c = ca[i];\n        while (c.charAt(0) == ' ') {\n            c = c.substring(1);\n        }\n        if (c.indexOf(name) == 0) {\n            return c.substring(name.length, c.length);\n        }\n    }\n    return \"\";\n}\n\nArray.prototype.delayedForEach = function(callback, timeout, thisArg, done){\n    var i = 0,\n        l = this.length,\n        self = this;\n\n    var caller = function() {\n        callback.call(thisArg || self, self[i], i, self);\n        if(++i < l) {\n            setTimeout(caller, timeout);\n        } else if(done) {\n            setTimeout(done, timeout);\n        }\n    };\n\n    caller();\n};\n\nArray.prototype.remove = function() {\n    var what, a = arguments, L = a.length, ax;\n    while (L && this.length) {\n        what = a[--L];\n        while ((ax = this.indexOf(what)) !== -1) {\n            this.splice(ax, 1);\n        }\n    }\n    return this;\n};\n\n\n//# sourceURL=webpack:///./js/utils.js?");
